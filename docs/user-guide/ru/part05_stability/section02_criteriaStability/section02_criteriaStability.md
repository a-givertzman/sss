...
В таблице критериев остойчивости приводится сводная информация по выполнению критериев остойчивости, предъявляемых к судну. В таблице приводится: 
...
| 8   | Максимальное плечо ДСО при перевозке леса             | м           | [1] раздел 3.3.5                 |
